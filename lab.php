...
header('location:index.php');
    ...
    $sqlcheck ="SELECT buffer FROM appbuffer WHERE buffer=:sysbuffer AND lab = :lab";
    $querycheck= $dbh -> prepare($sqlcheck);
    $querycheck-> bindParam(':sysbuffer', $sysbuffer, PDO::PARAM_STR);
    $querycheck-> bindParam(':lab', $lab, PDO::PARAM_STR);
    $querycheck-> execute();
	...
	<div class="login-page bk-img">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
                        ...
                        <div class="clearfix">
                            ...
                            <h3 class="pull-right text-bold">Type : LAB </h3>
                        </div>
                ...
                <form action="process-lab.php" method="post">
